...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->execute()) {
        echo "<script>alert('Data agama berhasil diperbarui!'); window.location='data_agama.php';</script>";
    } else {
...
<body>
    ...
    <div class="container">
        ...
        <form method="POST">
            <input type="text" name="nama_agama" value="<?= htmlspecialchars($data['nama_agama'] ?? '') ?>" required>
            <div class="button-group">
                <button type="submit">Simpan</button>
                <a href="data_agama.php" class="back-btn">Batal</a>
            </div>
        </form>
    </div>
