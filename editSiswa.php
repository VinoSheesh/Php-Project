                                ...
                                <form method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select id="kode_jurusan" name="kode_jurusan" class="form-select" required>
                                                <?php while ($jurusan = $jurusanResult->fetch_assoc()) { ?>
                                                    <option value="<?= $jurusan['kode_jurusan']; ?>"
                                                        <?= ($result['kode_jurusan'] == $jurusan['kode_jurusan']) ? "selected" : ""; ?>>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select id="kelas" name="kelas" class="form-select" required>
                                                <option value="X" <?= ($result['kelas'] == 'X') ? "selected" : ""; ?>>Kelas
                                                    X</option>
                                                <option value="XI" <?= ($result['kelas'] == 'XI') ? "selected" : ""; ?>>
                                                    Kelas XI</option>
                                                <option value="XII" <?= ($result['kelas'] == 'XII') ? "selected" : ""; ?>>
                                                    Kelas XII</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" id="alamat" name="alamat"
                                                value="<?= $result['alamat']; ?>" class="form-control" required>
                                        </div>
                                            ...
                                            <select id="id_agama" name="id_agama" class="form-select" required>
                                                ...
                                                while ($agama = $agamaResult->fetch_assoc()) { ?>
                                                    <option value="<?= $agama['id_agama']; ?>"
                                                        <?= ($result['id_agama'] == $agama['id_agama']) ? "selected" : ""; ?>>
                                                        <?= $agama['nama_agama']; ?>
                                                    </option>
                                                <?php } ?>
                                            </select>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" id="no_hp" name="no_hp" value="<?= $result['no_hp']; ?>"
                                                class="form-control" required>
                                        </div>
                                    </div>
